...
\cventry
  ...
  {%
    \cvplain{Working on LLVM-based compiler and ROCm software stack}
  }
...
\cventry
  ...
  {Remote (contract)}
  {%
    \cvplain{Supervising student research and thesis projects}
  }
...
\cventry
  ...
  {Remote (contract)}
  {%
   \cvplain{Working as a lecturer for several subjects: \textit{Introduction to Compilers}, \textit{Parallel Programming}, \textit{Basics of AI accelerators programming}.}
   \vspace{0.1em}
...
\cventry
  ...
  {Remote}
  {\cvbullets{
    \item Participate in the ITLab initiative and supervise voluntary IT classes and project-based work for Bachelor's degree students
    \item Mentor project teams of 2 -- 6 students from topic definition to implementation and final project review
    \item Topics: 10.2025 -- present (6 students): Android applications development with LLM workflows based on OpenVINO Java API and ARM CPU plugin
    \item Topics: 10.2025 -- present (3 students): optimization of neural network layers for LLM tasks on embedded RISC-V architectures in OpenVINO Toolkit
    \item Topics: 10.2024 -- present (4 students): neural network inference using ARM Compute Library and industrial software development
    \item Topics: 10.2023 -- present (3 -- 4 students): neural network inference framework implementation and industrial software development
    \item Topics: 10.2022 -- 06.2023 (2 students): computer vision algorithms optimization on embedded devices
    \item Topics: 10.2021 -- 06.2022 (2 students): neural networks optimization on ARM architecture
    \item Project materials and source code: \href{https://github.com/embedded-dev-research}{github.com/embedded-dev-research}
  }}
...
\cventry
  {09.2021 -- 06.2023}
  {Nizhny Novgorod State University}
  {Master's degree with honors, Fundamental Informatics and IT}
  {Nizhny Novgorod, Russia}
  {\cvbullets{
